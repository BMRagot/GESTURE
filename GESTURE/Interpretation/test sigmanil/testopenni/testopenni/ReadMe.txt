========================================================================
   APPLICATION CONSOLE : Vue d'ensemble du projet testopenni
========================================================================

AppWizard a créé cette application testopenni pour vous.

Ce fichier contient un résumé des éléments contenus dans chaque fichier qui
constitue votre application testopenni.
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH) nommé testopenni.pch et un fichier de types précompilés 
    nommé StdAfx.obj.
